...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            HelloWorld("Donald Knuth"); // call to HelloWorld(string name) again with a differnt paramater value
            ...
            // call to Sum (decimal num1, decimal num2) and storing the return value ina a variable
            decimal sum = Add (inputNumber1, inputNumber2);
            Console.WriteLine($"Summation: {sum}");// output the value to sum to console

            // if you don't plan on using variable, you can simplify the methods call like the lines below
            ...
            Console.WriteLine($"Divison : {Divide(inputNumber1, inputNumber2)}");
         ...
         * if you type '///' on top of a class method,
         ...
         * <summary></summary> used to describe a type of member
        ...
        // NOTE: Method definitons are programmed inside the class { } code block, not inside Main () { }
        ///<summary>
        /// Method without parmeters and return value 
        /// </summary>
